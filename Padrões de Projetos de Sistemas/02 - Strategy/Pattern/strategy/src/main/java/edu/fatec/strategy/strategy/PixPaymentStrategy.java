...
public class PixPaymentStrategy implements PaymentStrategy {
    ...
    public PaymentDTO executePayment(PaymentDTO paymentDTO)  {
        ...
        // Calculando desconto (10% do valor total)
        BigDecimal discount = unitaryPrice.multiply(BigDecimal.valueOf(quantity)).multiply(BigDecimal.valueOf(0.1)).setScale(2, RoundingMode.HALF_UP);
